...
export async function login(scope?: string) {
  ...
  const requestedScope = scope || "openid offline_access user collection bookmark note preference.read preference.update reading_session goal streak activity_day";
