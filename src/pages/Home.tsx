          ...
          content: JSON.stringify([
            {
              type: "h1",
              id: "welcome-header",
              children: [{ text: "مرحباً بك في تطبيق كمل" }],
            },
            {
              type: "p",
              id: "intro-1",
              children: [
                {
                  text: "هذا التطبيق يتيح لك إنشاء وتحرير المستندات بسهولة. إليك كيفية استخدامه:",
                },
              ],
            },
            {
              ...
              id: "features-list",
              children: [
                { type: "li", children: [{ text: "اضغط على زر + لإنشاء صفحة جديدة" }] },
                { type: "li", children: [{ text: "استخدم شريط الأدوات لتنسيق النص" }] },
                { type: "li", children: [{ text: "حفظ المستندات تلقائياً" }] },
                { type: "li", children: [{ text: "تصفح جميع صفحاتك من القائمة الجانبية" }] },
              ],
            },
            {
              type: "p",
              id: "get-started",
              children: [{ text: "ابدأ بإنشاء صفحتك الأولى الآن!" }],
            },
          ]),
